...
2) Go to the `Data Science Projects` section and access your application's project named `rag-nov6-4-v`

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rag-nov6-4-v-notebook`
...
5) In the terminal, run `cd rag-nov6-4-v` to navigate to your sample app's directory
